...
//
//
//  Created by Adon Omeri on 2025-05-05.
//
...
public enum LuminareButtonStyles {
    public static var regular: some ButtonStyle { LuminareButtonStyle() }
    public static var destructive: some ButtonStyle { LuminareDestructiveButtonStyle() }
    public static var compact: some ButtonStyle { LuminareCompactButtonStyle() }

    public static func cosmetic(_ image: Image) -> some ButtonStyle {
        LuminareCosmeticButtonStyle(image)
    }
}

public extension View {
    public func luminareBordered() -> some View {
        self.modifier(LuminareBordered())
    }
}
