...
public extension View {
    public func luminareCroppedSectionItem(isFirstChild: Bool, isLastChild: Bool) -> some View {
        self.modifier(LuminareCroppedSectionItem(isFirstChild: isFirstChild, isLastChild: isLastChild))
    }
}
